 ...
 */
export type ConductorFormData = z.input<typeof conductorSchema>

/**
 * Datos después de pasar por la validación de Zod.
 */
export type ConductorFormValidated = z.output<typeof conductorSchema>
 ...
 */
export type ConductorLicenciaData = z.input<typeof conductorLicenciaSchema>
